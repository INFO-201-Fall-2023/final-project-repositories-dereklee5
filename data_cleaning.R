...
#merge_data <- merge(data_05, data_18, by.x = "Categories", by.y = "Categories", all.x = TRUE)

#both_df <- as.data.frame(t(avg_df))
#both_df$Categories <- rownames(both_df)
#both_df <- subset(both_df, V1 < 1000)
